...
import { User, SearchNormal, Bezier, Wallet, ArrowUp, Clock, Category, CloseCircle, Star1, Home, Car, Cake, Briefcase, ShoppingCart, Airpod, Bill, DiscountShape, NoteFavorite, Send2 } from 'iconsax-react-native';
...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image
        source={require('./src/assets/Sprite.png')}
      ...
      <View style={styles.mainContent}>
        <View style={styles.iconRow}>
          <View style={[styles.iconContainer]}>
            <Bezier color="black" variant="Linear" size={50} style={{backgroundColor: '#dbface'}} />
      ...
      <View style={styles.content}>
        ...
        <View style={styles.contentBox}>
          ...
          <Image
            source={require('./src/assets/Driver.png')}
